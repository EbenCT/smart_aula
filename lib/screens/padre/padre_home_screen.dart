...
class PadreHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<AuthService>(
      builder: (context, authService, child) {
        return Scaffold(
          appBar: AppBar(
            title: const Text('Portal Padre/Madre'),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text(
                            'Las funcionalidades para seguimiento de estudiantes estarán disponibles próximamente.',
                            style: TextStyle(
                              fontSize: 16,
